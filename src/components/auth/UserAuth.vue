<template>
  <div class="flex flex-col  items-center h-[100vh] p-6">
    ...
    <div class="flex flex-col p-7 bg-cusdarkblue rounded-md gap-3 justify-center mt-12 w-full  md:max-w-[400px]">
        <h2 class="text-3xl">Login</h2>
        <form class="flex flex-col gap-3 mt-3">
            <div class=" border-b-cusgrey border-b-[1px]">
                <input class=" outline-none bg-transparent h-10" type="email" placeholder="Email Address">
            </div>
            <div class=" border-b-cusgrey border-b-[1px]">
                <input class=" outline-none bg-transparent h-10" type="password" placeholder="Password">
            </div>
            <div class=" border-b-cusgrey border-b-[1px]" v-if=" mode == 'signup'">
                <input class=" outline-none bg-transparent h-10" type="password" placeholder="Repeat Password">
            </div>
